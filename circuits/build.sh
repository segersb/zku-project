...
if [ -f ./build/powersOfTau28_hez_final_19.ptau ]; then
    echo "powersOfTau28_hez_final_19.ptau already exists. Skipping."
else
    echo 'Downloading powersOfTau28_hez_final_19.ptau'
    wget -P ./build https://hermez.s3-eu-west-1.amazonaws.com/powersOfTau28_hez_final_19.ptau
fi
...
snarkjs groth16 setup ./build/utilityClaim.r1cs ./build/powersOfTau28_hez_final_19.ptau ./build/utilityClaim_0000.zkey
